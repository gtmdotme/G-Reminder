...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    void insertReminderToDB(Reminder reminder){
        ...
        values.put(COLUMN_FROM_TIME, reminder.getFromTime().toString());
        values.put(COLUMN_TO_TIME, reminder.getToTime().toString());
            // Inserting Row
        ...
        try{
            ...
            if(cursor.getCount() > 0) {
                ...
                reminder = new Reminder(
                        ...
                        cursor.getString(cursor.getColumnIndex(COLUMN_FROM_TIME)),
                        cursor.getString(cursor.getColumnIndex(COLUMN_TO_TIME))
                );
            }
        }finally {
            db.close();
